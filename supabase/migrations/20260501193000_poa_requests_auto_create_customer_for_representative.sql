...
BEGIN
  ...
  IF resolved_customer_id IS NULL THEN
    INSERT INTO public.customers (name, phone, tax_id, address, created_by_profile_id)
    VALUES (employer_name, employer_tel, employer_tax_id, employer_address, rep_profile_id)
