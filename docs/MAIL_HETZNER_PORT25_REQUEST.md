...
> 🔄 **บริบทเปลี่ยน 2026-08-17**: เมลไม่ใช่ผลิตภัณฑ์ขายแล้ว (ใช้ภายใน + exworker) — คำขอนี้
> **ยังคุ้มที่จะยื่น** เพราะปลดได้ = ส่งเองฟรี ไม่มีเพดานรายวัน ไม่มีโลโก้ผู้ให้บริการ relay
> แต่ถ้าถูกปฏิเสธ **ไม่ต้องย้ายโฮสต์** อยู่กับ relay ต่อได้ (ดู `MAIL_SELF_DELIVERY_PLAN.md`)
> · ปรับข้อความ "for business mailboxes we host for our customers" ในคำขอให้ตรงกับความจริงก่อนส่ง
