...
- [ ] `terraform apply` ผ่าน (**ยังไม่ทำ — รอสั่ง** · ต้องมีบัญชี Hetzner + token ก่อน)
...
| --------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| ~~Terraform ยังไม่เคย validate จริง~~ ✅ validate ผ่านแล้ว 2026-08-15 | เหลือแค่ `apply` (ยังไม่เคยยิง API จริง — error ตอนสร้างของจริงยังเป็นไปได้) |
