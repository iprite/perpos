...
- [x] **บันทึกค่าเครื่องลง `infra_costs` แล้ว (2026-08-18)** — Hetzner/Contabo อยู่นอกท่อ `billing_export`
      ⇒ **ต้องกรอกมือทุกเดือน** (`source='manual'`) · ส.ค. 2026: `hetzner-mail-cx23` $1.08 (อายุ 15–18 ส.ค.)
      + `contabo-mail-vps4` $2.98 (18–31 ส.ค.) · **เดือนถัดไปเป็น $6.60 เต็มเดือน**
- [~] ~~**ขอปลดพอร์ต 25 ขาออกกับ Hetzner**~~ — ไม่ต้องแล้ว ย้ายไป Contabo ที่เปิด 25 ให้ตั้งแต่แรก — ร่างคำขอพร้อมส่งที่
