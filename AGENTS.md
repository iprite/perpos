...
- **โดเมน (โปรเจกต์ Vercel `perpos` เดียว เสิร์ฟ 2 โดเมน)**: `app.perpos.ai` = Suite/Flow · **`mail.perpos.ai` = PERPOS Mail** (webmail)
  · เมลเซิร์ฟเวอร์อยู่คนละที่: **`mailserver.perpos.ai`** (Contabo EU — MX/PTR/HELO/ใบรับรอง ชี้ชื่อนี้ทั้งหมด · **ส่งตรงพอร์ต 25 ไม่ผ่าน relay**)
