...
| `MAIL_OAUTH_ISSUER`                   | issuer ของ OAuth (Stalwart) — prod = `https://stalwart.perpos.ai`                                                                                         | PERPOS Mail        |
