...
| **สลับมุมมอง/โหมด/ตัวกรอง/แท็บ (2–5 อย่าง)**            | `<SegmentedControl>`                                                                                                 | `@/components/ui/segmented`        |
| **ตัวเลือกที่เป็นค่าบันทึกลง DB (จด VAT/ไม่จด ฯลฯ)**    | `<RadioGroup>` — ดู DESIGN.md §7                                                                                     | `@/components/ui/radio-group`      |
