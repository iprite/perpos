  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // BLUE JEANS #5D9CEC — สีประจำ **PERPOS Mail** (คู่กับ MINT=Flow, BITTERSWEET=Suite)
        // เป็นน้ำเงินจริงตัวเดียวในระบบ: family `blue/sky/cyan` ถูก map เป็น CHARCOAL ไปแล้ว
        // ⇒ ใช้ `text-mail-*`/`bg-mail-*` เฉพาะแบรนด์ของ Mail เท่านั้น ห้ามเอาไปใช้เป็นสี info ทั่วไป
        mail: {
          50: "#F4F8FE",
          100: "#E9F1FD",
          200: "#D2E3FA",
