              ...
              {pager.rows.map((row, i) => (
                <TableRow key={`${row.journal_entry_id}-${i}`}>
                  ...
                  <TableCell align="right" tabular className="text-slate-700">
                    {row.debit > 0
                      ? row.debit.toLocaleString("th-TH", { minimumFractionDigits: 2 })
                      : ""}
                  </TableCell>
                  <TableCell align="right" tabular className="text-slate-700">
                    {row.credit > 0
                      ? row.credit.toLocaleString("th-TH", { minimumFractionDigits: 2 })
                      : ""}
                  </TableCell>
                  <TableCell
                    align="right"
                    tabular
                    className={`font-medium ${row.running_balance >= 0 ? "text-slate-800" : "text-red-600"}`}
                  >
