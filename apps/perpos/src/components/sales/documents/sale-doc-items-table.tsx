...
import type { SaleDocFormValues } from "./sale-doc-form-schema";

export function SaleDocItemsTable(props: {
  form:             UseFormReturn<SaleDocFormValues>;
  fieldArray:       UseFieldArrayReturn<SaleDocFormValues, "items", "id">;
  disabled:         boolean;
