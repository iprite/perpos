export const routes = {
  ...
  sales: {
    ...
    newInvoice:    "/sales/invoices/new",
    quotations:    "/sales/quotations",
    newQuotation:  "/sales/quotations/new",
    deposits:      "/sales/deposits",
    newDeposit:    "/sales/deposits/new",
    receipts:      "/sales/receipts",
    newReceipt:    "/sales/receipts/new",
    taxInvoices:   "/sales/tax-invoices",
    newTaxInvoice: "/sales/tax-invoices/new",
    etaxInvoices:  "/sales/etax-invoices",
    newEtaxInvoice:"/sales/etax-invoices/new",
    creditNotes:   "/sales/credit-notes",
    newCreditNote: "/sales/credit-notes/new",
    debitNotes:    "/sales/debit-notes",
    newDebitNote:  "/sales/debit-notes/new",
  ...
  purchase: {
    ...
    newDeposit:          "/purchase/deposits/new",
    goodsReceipts:       "/purchase/goods-receipts",
    newGoodsReceipt:     "/purchase/goods-receipts/new",
    expenses:            "/purchase/expenses",
    newExpense:          "/purchase/expenses/new",
    whtExpenses:         "/purchase/wht-expenses",
    newWhtExpense:       "/purchase/wht-expenses/new",
    taxInvoices:         "/purchase/tax-invoices",
    newTaxInvoice:       "/purchase/tax-invoices/new",
    paymentSummaries:    "/purchase/payment-summaries",
    newPaymentSummary:   "/purchase/payment-summaries/new",
    receivedCreditNotes: "/purchase/received-credit-notes",
    newReceivedCreditNote:"/purchase/received-credit-notes/new",
    receivedDebitNotes:  "/purchase/received-debit-notes",
    newReceivedDebitNote:"/purchase/received-debit-notes/new",
  },
  widgets: {
    cards: "/widgets/cards",
    icons: "/widgets/icons",
