    ...
    <article className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
      ...
      <div className="mt-6 space-y-6 text-sm leading-7 text-gray-700">
        ...
        <section className="rounded-xl border border-gray-200 bg-gray-50 p-4">
          ...
          <p className="mt-2">
            หากมีคำถามเกี่ยวกับข้อกำหนดการให้บริการ กรุณาติดต่อ <a className="font-medium text-gray-900 underline hover:text-gray-700" href="mailto:support@perpos.ai">support@perpos.ai</a>
          </p>
          <p className="mt-2">
