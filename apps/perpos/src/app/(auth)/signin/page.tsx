...
function SignInContent() {
  ...
  return (
    <div className="w-full">
      {/* LINE Login — ช่องทางหลัก (ผู้ใช้ B2C มาจาก LINE อยู่แล้ว) */}
      <a
        href={lineLoginHref}
        className="flex w-full items-center justify-center gap-2.5 rounded-lg bg-[#06C755] px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#05b34c] active:scale-[0.99]"
      >
