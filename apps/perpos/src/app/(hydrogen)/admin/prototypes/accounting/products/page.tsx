...
// products/page.tsx — A6 สินค้าและบริการ (master catalog)
// StatCard (สินค้า/บริการ/ทั้งหมด) + filter (ค้นหา/ประเภท/สถานะ) + Table row→ProductDialog (CRUD)
...
export default function ProductsPage() {
  ...
  const { products } = useAccountingData();
