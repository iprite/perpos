...
// documents/page.tsx — A3 เอกสารขาย (ใบเสนอราคา/ใบแจ้งหนี้/ใบเสร็จ)
// Tab (overflow-x-auto: ทั้งหมด/ใบเสนอราคา/ใบแจ้งหนี้/ใบเสร็จ)
// + StatCard (ออกบิล/รอรับชำระ/เกินกำหนด warning/รับแล้ว)
// + filter (ค้นหา/สถานะ) + Table row→DocumentDialog (detail+แก้+convert+ส่ง LINE)
...
import type { AccDocument, AccDocType } from "../_fixtures/types";
...
export default function DocumentsPage() {
  ...
  const { documents } = useAccountingData();
