...
// no-access.tsx — empty state "ไม่มีสิทธิ์เข้าถึง" ใช้ร่วมทุกหน้า hotel (DRY)
// ส่ง title + icon เข้า HotelShell · เนื้อหาอธิบายส่งผ่าน children

import { ShieldX } from "lucide-react";
import { Text } from "@/components/ui/typography";
import { HotelShell } from "./nav";
...
export function NoAccess({
  ...
  return (
    <HotelShell title={title} icon={icon}>
