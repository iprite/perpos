    ...
    <div className="space-y-5">
      ...
      {report.totals.unattributedUsd > 0 && (
        <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          ...
          ที่ยังผูกเจ้าของไม่ได้ — ส่วนใหญ่มาจากบอทตอบคำถามก่อนขายที่ยังไม่มีบัญชี
          และงานที่ยังไม่ได้ส่งบริบทเข้ามา · <b>ไม่ได้แสดงเป็นแถวในตารางด้านล่าง</b>{" "}
          แต่ยังนับอยู่ในต้นทุนรวมและราคาที่ควรเก็บ
        </div>
      )}
