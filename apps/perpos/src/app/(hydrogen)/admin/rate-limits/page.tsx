    ...
    <AdminPage
      ...
      actions={
        <Button onClick={openAdd} disabled={!orgId}>
          <Plus className="mr-1.5 h-4 w-4" /> เพิ่ม Limit
        </Button>
      }
    >
      {/* Org selector */}
      ...
      {totalViolations > 0 && (
        <div className="flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
          ...
          <span>
            พบ <strong>{totalViolations}</strong> การละเมิด limit ใน 24 ชั่วโมงที่ผ่านมา
          </span>
        </div>
      )}
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-400">
                  ใช้ * สำหรับทุก route หรือ /api/xxx/* สำหรับ prefix
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    className="mt-1"
                  />
                  <p className="mt-1 text-xs text-gray-400">60 = 1 นาที, 3600 = 1 ชั่วโมง</p>
                </div>
                <div>
          ...
          <DialogFooter>
            {editing && (
              <Button
                ...
                onClick={() => {
                  setModalOpen(false);
                  setDeleteConfirm({ open: true, id: editing.id });
                }}
              >
