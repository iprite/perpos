...
//    (self-grep exception ที่ตั้งใจ — บันทึก Review Log). ค่าสีอ้างอิง docs/line-flex-card-guide.md
//    T1/T2 รับ data จาก useData สด (SLA/ผู้รับ toggle ในหน้า settings → preview อัปเดต)

import type { Receivable } from "../_components";

// ── canned data T3/T4 (static preview เท่านั้น — ไม่ยิง LINE จริง) ──
...
const T3_PAID_FLEX_DATA: T3EventFlexData = {
  kind: "paid",
...
const T3_DELIVERED_FLEX_DATA: T3EventFlexData = {
  kind: "delivered",
