        ...
        <DialogBody>
            ...
            <div className="space-y-3">
              ...
              <FileDropzone
                ...
                label={
                  previewUrl
                    ...
                    : "คลิกหรือลากไฟล์รูปบิล/ใบส่งของมาวาง"
                }
              ...
              {!ocrLoading && !ocrError && lines.some((l) => l.name) && (
                <div className="flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 px-4 py-2.5">
                  <span className="text-sm font-medium text-green-600">✓ อ่านบิลสำเร็จ</span>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={addLine} className="h-7 text-indigo-600">
          ...
          {lines.some(
            (l) =>
              l.name && !existingItemNames.some((n) => n.toLowerCase() === l.name.toLowerCase()),
          ) && (
            <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-2.5 text-xs text-amber-800">
              <span className="font-semibold">⚠ สินค้าใหม่:</span>{" "}
              รายการที่ไม่มีในระบบจะถูกสร้างอัตโนมัติ (รหัส AUTO-…)
              คุณสามารถแก้ไขรหัสและรายละเอียดเพิ่มเติมได้ภายหลังในแท็บ
              &quot;ข้อมูลวัสดุ/สินค้า&quot;
            </div>
          )}
