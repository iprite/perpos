// backstage-badges.tsx (production) — map enum หลังบ้าน → StatusBadge + ป้ายไทย/glossary
// ใช้ร่วม B1/B2/B4 · tax_kind, tax_status, period_status, journal_source, account_type
// type จาก lib/accounting/types.ts (contract เดียว). copy จาก prototype (ตั้งใจ duplicate ให้ prod ยืนเอง)
