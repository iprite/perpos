...
import type { AssistantStats } from "@/lib/assistant/stats";
...
export default function UsageView({ stats, quota }: { stats: AssistantStats; quota: Quota }) {
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <div className="flex items-center gap-2 text-sm font-semibold text-gray-700">
              <Wallet className="h-4 w-4 text-primary" /> กระเป๋าเครดิต
            </div>
