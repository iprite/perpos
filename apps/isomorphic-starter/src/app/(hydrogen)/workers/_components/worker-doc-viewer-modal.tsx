...
async function getSignedStorageUrl(input: { supabase: any; table: "worker_documents"; id: string; disposition: "inline" | "attachment" }) {
...
export function WorkerDocViewerModal({
  ...
  useEffect(() => {
    ...
    Promise.resolve()
      .then(async () => {
        const signed = await getSignedStorageUrl({ supabase, table: "worker_documents", id: docId, disposition: "inline" });
        setUrl(signed);
      })
      .catch((e: any) => {
          ...
          <div className="flex shrink-0 gap-2">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                setError(null);
                try {
                  const signed = await getSignedStorageUrl({ supabase, table: "worker_documents", id: docId, disposition: "attachment" });
