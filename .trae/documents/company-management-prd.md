...
| ตัวแทน (Representative) | จัดการตัวแทนของนายจ้าง/ลูกค้า | เปิดป๊อปอัปเพิ่ม/แก้ไขตัวแทน โดย: กรอกอีเมล, เลือกสถานะ 3 ค่า (ปกติ/พักใช้/ยกเลิกถาวร), อัปโหลดรูป, จัดการรายการเอกสารแนบเป็นลิงก์ Google Drive (เพิ่ม/แก้ไข/ลบ/เปิด), และ **ไม่มีปุ่ม import** |
